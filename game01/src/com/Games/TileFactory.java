...
public class TileFactory {
    ...
    public Enemy produceEnemy(char tile, Position position, MessageCallBack messageCallback, GameLevel gameLevel) {
        Enemy enemy = enemiesMap.get(Character.valueOf(tile)).get();
